...
TRUNCATE TABLE `member_diet_assignments`;
TRUNCATE TABLE `diet_meals`;
TRUNCATE TABLE `diet_plans`;
TRUNCATE TABLE `member_workout_assignments`;
...
(1, 1, 3, '2026-04-15', '2026-10-15', 229.00, 'active', TRUE),      -- Alex: Active Platinum (Expires Oct 15)
(2, 2, 2, '2026-06-21', '2026-09-21', 129.00, 'active', FALSE),     -- Sarah: Gold (Expires in 3 days! Expiring soon)
(3, 3, 1, '2026-08-10', '2026-09-10', 49.00, 'expired', FALSE),     -- Jordan: Silver (Expired on Sep 10)
(4, 4, 4, '2026-03-01', '2027-03-01', 399.00, 'active', TRUE),      -- Samantha: Apex Black (Expires next year)
...
(1, 'Membership Expiring Soon', 'Member Sarah Connor (APX-1002) Gold Performance membership expires in 3 days.', 'warning', FALSE, '2026-09-18 08:00:00'),
(1, 'New Member Onboarded', 'Emily Watson registered for Gold Performance membership.', 'success', FALSE, '2026-09-18 09:30:00'),
(1, 'Membership Expired', 'Jordan Miller (APX-1003) membership has expired.', 'reminder', TRUE, '2026-09-11 00:00:00'),

-- Alex Rivera Notifications (user_id = 5)
(5, 'Workout Plan Active', 'Your trainer Marcus Vance updated your 5-Day Hypertrophy Routine.', 'info', FALSE, '2026-09-16 10:00:00'),
(5, 'Payment Receipt Available', 'Invoice INV-202604-1001 for $229.00 has been verified.', 'success', TRUE, '2026-04-15 12:00:00'),
(5, 'Check-in Verified', 'Check-in recorded at 07:15 AM today. Great job showing up!', 'info', FALSE, '2026-09-18 07:15:00'),
