...
(5, 'Student Scholar Pass', 'PLAN-STUDENT', 6, 89.00, 'Special college student discount package with flexible off-peak access.', '["College Student ID Verified", "Full Gym Floor Access", "Sauna & Steam Bath", "Off-Peak Free Locker", "Apex Mobile App Access"]', 'Student Discount', 1);
...
(8, 8, 5, '2026-09-15', '2027-03-15', 89.00, 'active', 1);       -- Emily: Student Scholar Pass
...
(1, date('now'), '07:15:00', '08:45:00', 'present', 'Chest & Triceps session complete'),
(2, date('now'), '08:30:00', '09:40:00', 'present', 'HIIT Mobility circuit'),
(4, date('now'), '06:45:00', '08:15:00', 'present', 'Early morning heavy back day'),
(5, date('now'), '09:00:00', NULL, 'present', 'Currently in cardio theater'),
(7, date('now'), '11:15:00', NULL, 'present', 'Leg day with trainer Marcus'),
(8, date('now'), '12:00:00', NULL, 'present', 'College Student workout session'),

-- Historical Records
(1, date('now', '-1 day'), '07:20:00', '08:50:00', 'present', 'Back & Biceps'),
(2, date('now', '-1 day'), '08:15:00', '09:30:00', 'present', 'Recovery sauna & stretch'),
(4, date('now', '-1 day'), '07:00:00', '08:30:00', 'present', 'Shoulders & Calves'),
(6, date('now', '-1 day'), '17:30:00', '18:45:00', 'present', 'Evening treadmill & core'),
(1, date('now', '-2 day'), '07:10:00', '08:40:00', 'present', 'Leg day'),
(5, date('now', '-2 day'), '08:45:00', '10:00:00', 'present', 'Bench press volume'),
(7, date('now', '-2 day'), '12:00:00', '13:15:00', 'present', 'Full body workout'),
(1, date('now', '-3 day'), '07:30:00', '09:00:00', 'present', 'Shoulders & Arms'),
(2, date('now', '-3 day'), '08:00:00', '09:15:00', 'present', 'Conditioning'),
(4, date('now', '-3 day'), '06:30:00', '08:00:00', 'present', 'Squats & Quads');
...
(1, date('now'), '06:00:00', NULL, NULL, 'present', 'Morning Olympic lifting shift - Active'),
(2, date('now'), '08:00:00', '16:00:00', 8.00, 'completed', 'HIIT & Mobility shift - Completed');
